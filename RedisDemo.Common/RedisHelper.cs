    ...
    public class RedisHelper
    {
        ...
        public RedisHelper(int dbNum, string readWriteHosts)
        {
            ...
            _conn =
                ...
                StackExchangeRedisHelper.Instance :
                StackExchangeRedisHelper.GetConnectionMultiplexer(readWriteHosts);
        }
        ...
        {
            var prefixKey = CustomKey ?? StackExchangeRedisHelper.SysCustomKey;
